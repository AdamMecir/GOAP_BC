...
public class GoToIronMine : GAction
{
    ...
    public string parentTag = "IronParent"; // Tag of the parent GameObject
    ...
    public override bool PostPerform()
    {
        if (this.target != null)
        {
            ...
            if (replacementObjects != null && replacementObjects.Count > 0)
            {
                ...
                GameObject newIron = Instantiate(chosenReplacement, spawnPosition, randomRotation);
                ...
                if (parentObject != null)
                {
                    ...
                    newIron.transform.SetParent(parentObject.transform);
