...
public class IronRespawn : MonoBehaviour
{
    public GameObject ironPrefab; // Assign this in the Unity Editor with the prefab you want to spawn
    ...
    void Update()
    {
        ...
        if (timer <= 0)
        {
            ...
            Instantiate(ironPrefab, transform.position, Quaternion.identity);
